...
public class HelloController {
	...
	//for date to display otherwise throws error 404
	@InitBinder
...
//	}
	...
	public String createCookie(ModelMap map, HttpServletResponse response) {
		...
		Cookie cookie = new Cookie("name", "shru");
	...
	public String readCookie(ModelMap map, @CookieValue(name = "name", required = false) String name) {     //required = flase means if cookie is not created return null and if created returns name 
